...
@musis: Frozen Jam by tgfcoder <https://twitter.com/tgfcoder> licensed under CC-BY-3 <http://creativecommons.org/licenses/by/3.0/>
File(s): 

@sounds: Art for Kenney.n1
'''
...
#Iniciar pygame y create window
pygame.init()
pygame.mixer.init()
...
while running:
    ...
    #check for collision between bullet and mobs
